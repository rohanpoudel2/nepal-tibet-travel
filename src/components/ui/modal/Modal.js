...
const Modall = ({ openModal, setOpenModal }) => {
  ...
  return (
    ...
    >
      <Box sx={style}>
        <div className="bg-gray-100 w-full p-4 rounded-xl md:w-[400px] lg:w-[500px]">
          <div
          ...
          >
            ...
            <div
              className="bg-gray-300 hover:bg-gray-500 cursor-pointer hover:text-gray-300 text-gray-500 text-xl w-8 h-8 flex items-center justify-center rounded-full"
          ...
          <div className="my-4">
            ...
            <div className="border-2 border-gray-200 flex justify-between items-center mt-4 py-2">
              ...
              <input className="w-[70%] outline-none bg-transparent mr-auto" type="text" placeholder="link" defaultValue={url} readOnly />
              <button className="bg-blue-400 text-white rounded text-sm py-2 px-5 mr-2 hover:bg-blue-500">
                Copy
              </button>
            </div>
          </div>
