...
const Modal = () => {
  ...
  return (
    <div className="fixed top-0 left-0 w-screen h-screen z-[99999] bg-black bg-opacity-50 flex justify-center items-center">
      <div className="bg-gray-100 w-full mx-4 p-4 rounded-xl md:w-1/2 lg:w-1/3">
        ...
        <div className="my-4">
          ...
          <div className="border-2 border-gray-200 flex justify-between items-center mt-4 py-2">
            ...
            <input className="w-full outline-none bg-transparent" type="text" placeholder="link" defaultValue={url} readOnly />
