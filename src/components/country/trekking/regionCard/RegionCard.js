...
const RegionCard = ({ image, name, desc, page_link, country, activity }) => {
  return (
    <div className="relative max-w-full sm:max-w-[256px] bg-white border border-gray-200 rounded-lg shadow">
      ...
      <div className="p-5">
        ...
        <Link href={`/country/${country}/${activity.toLowerCase()}/${page_link}`} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-[#47A5CF] rounded-lg hover:bg-sky-600 focus:ring-4 focus:outline-none focus:ring-blue-300">
          Explore
